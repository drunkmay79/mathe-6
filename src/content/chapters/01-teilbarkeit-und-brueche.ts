  ...
  lessons: [
    {
      ...
      summary:
        'Кратные — что получается, если умножать число на 1, 2, 3 и дальше. Делители — на что число делится без остатка. Отсюда же ggT и kgV, которые понадобятся во всей главе про дроби.',
      terms: [
        'teiler',
        'vielfaches',
        'teilbar',
      ...
      theory: [
        {
          type: 'text',
          body: {
            de: 'Wenn man eine Zahl mit 1; 2; 3; … multipliziert, erhält man die Vielfachen dieser Zahl. Es gibt unendlich viele Vielfache.',
            ru: 'Если умножать число на 1, потом на 2, на 3 и дальше, получаются кратные этого числа. Кратных бесконечно много — список никогда не заканчивается.',
          },
        },
        {
          type: 'rule',
          ...
          body: {
            ...
            ru: 'Кратные записывают множеством: в фигурных скобках, через точку с запятой. Многоточие в конце обязательно — оно и означает «и так далее без конца».',
          },
        ...
        },
        {
          type: 'example',
          prompt: {
            de: 'Bestimme die ersten fünf Vielfachen der Zahl 6.',
            ru: 'Найди первые пять кратных числа 6.',
          },
          steps: [
            {
              expr: '1 \\cdot 6 = 6',
              explain: 'Умножаем 6 на 1 — получаем первое кратное.',
            },
            {
              expr: '2 \\cdot 6 = 12 \\qquad 3 \\cdot 6 = 18',
              explain: 'Дальше на 2, на 3 и так далее. Каждый шаг добавляет ещё одну шестёрку.',
            },
            {
              expr: 'V_{6} = \\{6;\\ 12;\\ 18;\\ 24;\\ 30;\\ \\dots\\}',
              explain: 'Записываем множеством и не забываем многоточие.',
            },
          ],
        },
        {
          ...
          body: {
            ...
            ru: 'Делители — числа, на которые делится без остатка. В отличие от кратных, делителей у числа конечное количество, их можно выписать все.',
          },
          expr: 'T_{4} = \\{1;\\ 2;\\ 4\\}',
        },
        {
          ...
          steps: [
            {
              expr: '18 : 1 = 18',
              explain: 'Делим по порядку, начиная с единицы. Сразу два делителя: 1 и 18.',
            },
            {
              expr: '18 : 2 = 9',
              explain: 'Снова пара: 2 и 9. Делители всегда находятся парами.',
            },
            {
              expr: '18 : 3 = 6',
            ...
            },
            {
              ...
              explain: 'На 4 и на 5 без остатка не делится — они не делители.',
            },
            {
              expr: 'T_{18} = \\{1;\\ 2;\\ 3;\\ 6;\\ 9;\\ 18\\}',
              explain:
                'Следующее число — 6, но оно уже есть в паре с тройкой. Числа пошли по второму кругу, значит найдены все делители и дальше проверять не нужно.',
            },
          ],
        },
        {
          ...
          body: {
            ...
            ru: 'ggT — наибольший общий делитель (НОД). kgV — наименьшее общее кратное (НОК). В немецком их пишут именно так, с маленькой буквы в начале.',
          },
          ...
          steps: [
            {
              ...
              explain: 'Выписываем кратные первого числа.',
            },
            {
              expr: 'V_{6} = \\{6;\\ 12;\\ 18;\\ 24;\\ 30;\\ \\dots\\}',
              explain: 'Теперь кратные второго.',
            },
            {
              expr: '12;\\ 24;\\ 36;\\ \\dots',
              explain: 'Общие кратные — те числа, что встретились в обоих списках.',
            },
            {
              expr: '\\text{kgV}(4;\\ 6) = 12',
              explain: 'Самое маленькое из общих кратных и есть kgV.',
            },
          ],
        },
      ],
